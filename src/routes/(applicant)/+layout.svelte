<script>
  ...
  // ambil props dari +layout.server.js
  let { data } = $props();
  ...
  function openProfileModal() { showProfileModal = true; }
  function openPrivacyModal() { showPrivacyModal = true; }
