          ...
          <div class="overflow-hidden rounded-lg border border-gray-200">
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr><td class="px-4 py-2 text-sm text-gray-900">John Doe</td><td class="px-4 py-2 text-sm text-gray-700">NAP-00123</td><td class="px-4 py-2 text-sm"><span class="rounded bg-yellow-100 px-2 py-0.5 text-yellow-800">Monitor</span></td></tr>
                <tr><td class="px-4 py-2 text-sm text-gray-900">Jane Smith</td><td class="px-4 py-2 text-sm text-gray-700">NAP-00456</td><td class="px-4 py-2 text-sm"><span class="rounded bg-green-100 px-2 py-0.5 text-green-800">Aman</span></td></tr>
              </tbody>
            </table>
          </div>
        </section>
      ...
      {#if currentKey === 'new'}
        <section class="space-y-4">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="bg-gray-50 rounded-lg p-4"><div class="text-xs text-gray-500">Aman</div><div class="mt-1 text-2xl font-bold text-gray-900">86</div></div>
          </div>
        </section>
      {/if}
      ...
      <!-- {#if currentKey === 'history'}
        <section class="space-y-4">
          ...
          <ul class="list-disc pl-6 text-sm text-gray-700 space-y-2">
            <li>2025-09-01 10:10 - superadmin melihat daftar</li>
